...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/cantera-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cantera-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add cantera libcantera libcantera-devel
# for installing globally
pixi global install cantera libcantera libcantera-devel
```
...
It is possible to list all of the versions of `cantera` available on your platform:
...
```
pixi search cantera --channel conda-forge
```
